...
public class string01 {
	...
	public static void main(String[] args) {
		...
		//comparTo(str) : str문자열과 비교하여 같으면0, 사전순으로 앞이면 -1, 뒤면 1
		...
		System.out.println("abd".concat("efg"));
		...
		String email = "dmsq1@naver.co.kr";
		...
		//parseint : 문자를 숫자로 변환
		int num3 =Integer.parseInt(num1); //integer< int의 클래스
