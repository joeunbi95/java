...
public class Subjects {
	...
	*/
	...
	//과목코드, 과목명, 학점만 받는 생성자
	public Subjects(String subCode, String subName, double subCredite) {
	...
	//전체 데이터를 받는 생성자
	public Subjects(String subCode, String subName, double subCredite, int subTime, String subProfessor,
