...
public class 정리 {
	...
	public static void main(String[] args) {
		 ...
		 *  - while(조건식){
		 *  	실행문;
		 *  	-실행문에 반드시 조건식 false가 될수있는 구문을 포함.
		 *    }
		 *    
